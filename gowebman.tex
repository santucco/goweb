...
\def\runninghead{{\tentt GOWEB} USER MANUAL (VERSION 0.4)}
...
\vskip 18pt\centerline{(Version 0.4 --- January 2013)}
\vskip 32pt

\centerline{\it Based on}
\vskip 6pt
\centerline{\it The CWEB System of
    Structured Documentation}
\vskip 6pt
\centerline{\it by}
\vskip 6pt
\centerline{\it Donald E. Knuth and Silvio Levy}
\vfill
...
\smallskip\noindent
The electronic form is copyright \copyright\ 2013 by Alexander Sychev.
...
the corresponding \TEX/ code output by \.{GOWEAVE}, when run on \.{common.w}.
