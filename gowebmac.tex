% standard macros for GOWEB listings (in addition to plain.tex)
% Version 0.82 --- September 2013
\ifx\renewenvironment\undefined\else\endinput\fi % LaTeX will use other macros
\xdef\fmtversion{\fmtversion+GOWEB0.82}
\chardef\GOWEBversion=0 \chardef\GOWEBrevision=8
\newif\ifpdf
\ifx\pdf+\pdftrue\fi
...
\def\Go{\GO/} % for backward compatibility
\def\9#1{}
...
\def\oct{\hbox{$^\circ$\kern-.1em\it\aftergroup\?\aftergroup}}% GOWEB style
\def\hex{\hbox{$^{\scriptscriptstyle\#}$\tt\aftergroup}} % GOWEB style
...
\gtitle={\.{GOWEB} output} % this running head is reset by starred sections
\mark{\noexpand\nullsec0{\the\gtitle}}
...
\def\today{\ifcase\month\or
  ...
  September\or August\or September\or October\or November\or December\fi
  \space\number\day, \number\year}
\newcount\twodigits
